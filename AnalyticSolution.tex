...
evenly distributed point sources, $M = 50$, along the axial dimension of the
applicator at positions $r_{0_i}$. 
\begin{equation}\label{GreenSuperPosition}
  u = \sum_{i=1}^M u_h( r-r_{0_i}) + u_p( r-r_{0_i}) + u_a
\end{equation}
...
\[
 u(r,t) = u_a + \frac{\alpha}{k\; \gamma^2} q_\textit{laser} \left( 1 - \exp(-\gamma^2 t)\right)
 \qquad
...
\[
 \underbrace{\frac{\alpha}{k\; } q_\textit{laser}  \exp(-\gamma^2 t)}_{\frac{\partial u}{\partial t} }
 -  \alpha  \cdot
...
\underbrace{ 
  ...
  \left(
 \underbrace{
  \frac{\alpha}{k\; \gamma^2} q_\textit{laser} \left( 1 - \exp(-\gamma^2 t)\right)
   }_{u  - u_a }
   \right)
  = 
 \frac{\alpha}{k\; } q_\textit{laser}  \exp(-\gamma^2 t)
  +
 \frac{\alpha}{k\; } q_\textit{laser} 
      \left( 1 - \exp(-\gamma^2 t)\right)
  = 
 \frac{1}{\rho c_p } q _\textit{laser}
\]
