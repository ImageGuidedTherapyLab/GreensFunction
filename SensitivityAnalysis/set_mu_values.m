function [ all_opt_fig, no_pwr_fig, sim_dim, summary ] = set_mu_values ( max_phys_sz, choice );
...
[all_opt_fig, no_pwr_fig,sim_dim] = make_0W_1W_fields( inputdatavars, 50, max_phys_sz, mu_eff, w_perf, k_cond, choice );
end