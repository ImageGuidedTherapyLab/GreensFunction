...
function [all_opt_fig,all_opt_fig_s,no_pwr_fig,no_pwr_fig_s,sim_dim] = make_0W_1W_fields_DM ( inputdatavars, sources, max_phys_sz, mu_eff_list, w_perf, k_cond, choice )
...
if choice == 1
    ...
    [no_pwr_fig,no_pwr_fig_s] = GPU_kernel_calls_DM ( power_cold,spacing,scaling,mod_point,source,w_cold,k_cold,g_anisotropy,mu_cold,probe_u,robin_co,c_blood,choice);
    
elseif choice == 2
    
    w_cold = w_perf;
    [no_pwr_fig,no_pwr_fig_s] = GPU_kernel_calls ( power_cold,spacing,scaling,mod_point,source,w_cold,k_cold,g_anisotropy,mu_cold,probe_u,robin_co,c_blood,choice);
...
elseif choice == 4||choice==5
    choice_cold=2;
    w_cold = w_perf;
    [no_pwr_fig,no_pwr_fig_s] = GPU_kernel_calls ( power_cold,spacing,scaling,mod_point,source,w_cold,k_cold,g_anisotropy,mu_cold,probe_u,robin_co,c_blood,choice_cold);
    
end

power_log = 1;
[all_opt_fig,all_opt_fig_s] = GPU_kernel_calls_DM ( power_log,spacing,scaling,mod_point,source,w_perf,k_cond,g_anisotropy,mu_eff_list,probe_u,robin_co,c_blood,choice);
