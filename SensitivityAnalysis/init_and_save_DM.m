...
[ all_opt_fig,all_opt_fig_s, no_pwr_fig,no_pwr_fig_s,sim_dim, summary ] = set_mu_values_DM ( max_phys_sz, choice );
...
if choice == 1
    ...
    save ('all_opt_mu_small.mat','all_opt_fig','all_opt_fig_s','no_pwr_fig','no_pwr_fig_s','sim_dim','summary','-v7.3');
